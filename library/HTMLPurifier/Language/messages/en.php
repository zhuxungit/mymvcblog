...
// for unit testing purposes
    ...
    'Strategy_RemoveForeignElements: Foreign element to text.xml' => 'Unrecognized $CurrentToken.Serialized tag converted to text.xml',
    'Strategy_RemoveForeignElements: Foreign element removed' => 'Unrecognized $CurrentToken.Serialized tag removed',
    'Strategy_RemoveForeignElements: Comment removed' => 'Comment containing "$CurrentToken.Data" removed',
    'Strategy_RemoveForeignElements: Foreign meta element removed' => 'Unrecognized $CurrentToken.Serialized meta tag and all descendants removed',
    'Strategy_RemoveForeignElements: Token removed to end' => 'Tags and text.xml starting from $1 element where removed to end',
    ...
    'Strategy_MakeWellFormed: Unnecessary end tag to text.xml' => 'Unnecessary $CurrentToken.Serialized tag converted to text.xml',
    ...
    'Strategy_MakeWellFormed: Stray end tag to text.xml' => 'Stray $CurrentToken.Serialized tag converted to text.xml',
